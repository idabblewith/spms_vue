...
import MyTasksAndAssociations from "@/components/Base/Page/MyTasksAndAssociations.vue";
...
<template>
  <div>
    <div class="bg-gray-100 rounded-lg p-10 flex flex-col relative">
      ...
      <br />
      <p>
        Please update and submit (when ready) all documents awaiting your attention in "My Tasks", update project details
        and team lists of "My Projects" and "My Partnerships", create new projects and initiate closure of old projects as
        appropriate. If you get stuck, the User Manual has all the answers!
      </p>
    </div>
