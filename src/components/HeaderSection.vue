...
import ProjectMenuContents from './subcomponents/menu/ProjectMenuContents.vue';
import ReportMenuContents from './subcomponents/menu/ReportMenuContents.vue';
import StaffMenuContents from './subcomponents/menu/StaffMenuContents.vue';


import ProjectSearchBar from './subcomponents/ProjectSearchBar.vue'; // Replace with your ProjectSearchBar component
import NavitarComponent from './subcomponents/NavitarComponent.vue'; // Replace with your NavitarComponent component
    ...
    <div class="bg-black bg-opacity-80 py-2 rounded-b-lg">
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-2">
          <!-- SPMS Logo/Title -->
          <button
            class="px-5 text-white text-opacity-70 text-md focus:outline-none"
            @click="navigate('/')"
          >
